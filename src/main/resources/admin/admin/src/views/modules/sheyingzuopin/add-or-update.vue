    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="作品内容" prop="zuopinneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zuopinneirong" label="作品内容" prop="zuopinneirong">
                    <span v-html="ruleForm.zuopinneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.zuopinneirong = this.ruleForm.zuopinneirong.replace(reg,'../../../springboot07j52/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
